...
import fetchAllEvents from '@salesforce/apex/EventCalendarController.fetchAllEvents';
...
export default class FullCalendar extends LightningElement {
    ...
    renderedCallback() {
        ...
        loadScript(this, FullCalendarJS + '/demos/js/theme-chooser.js'),
